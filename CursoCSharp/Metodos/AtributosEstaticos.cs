...
namespace CursoCSharp.Metodos
{
     ...
     class AtributosEstaticos
    {
        ...
        {
            var produto1 = new Produto("Canenta", 3.2, 0.1);
            ...
            // agora classe Desconto permance static, assim todos passaram a conter desconto 0.1, pois pertence a classe desconto.
